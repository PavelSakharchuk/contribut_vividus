...
public class JiraEntityDeserializer extends JsonDeserializer<JiraEntity>
{
    @Override
    public JiraEntity deserialize(JsonParser parser, DeserializationContext ctxt) throws IOException
    {
