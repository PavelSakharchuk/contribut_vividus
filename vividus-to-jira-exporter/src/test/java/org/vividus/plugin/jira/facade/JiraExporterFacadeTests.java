...
class JiraExporterFacadeTests
{
    ...
    @Mock private JiraExporterOptions jiraExporterOptions;
    ...
    @Test
    void shouldUpdateManualTestCase()
        throws IOException, NonEditableIssueStatusException, JiraConfigurationException, NonTestCaseWithinRunException,
    ...
    @Test
    void shouldUpdateCucumberTestCase()
        throws IOException, NonEditableIssueStatusException, JiraConfigurationException, NonTestCaseWithinRunException, NonEditableTestRunException {
        initializeFacade(List.of(OPEN_STATUS));
...
//            createTestExecutionItem("test-1", TestCaseStatus.PASSED, null),
//            createTestExecutionItem("test-2", TestCaseStatus.FAILED, List.of(TestCaseStatus.PASSED,
...
//        testExecution.setTests(List.of(
//            createTestExecutionItem("test-one", TestCaseStatus.PASSED, null)
//        ));
...
//    private static TestExecutionItem createTestExecutionItem(String key, TestCaseStatus status,
//            List<TestCaseStatus> statusess)
//    {
...
//    }
    ...
    {
        CucumberTestCase testCase = createTestCase(TestCaseType.AUTOMATED,
