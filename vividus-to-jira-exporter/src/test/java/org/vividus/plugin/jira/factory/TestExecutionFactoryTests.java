...
//        assertExecutedItem(tests.get(0), TestCaseStatus.PASSED);
//        assertExecutedItem(tests.get(1), TestCaseStatus.FAILED);
//        assertItem(tests.get(2), TestCaseStatus.TODO, null, null);
//        assertExecutedItem(tests.get(3), TestCaseStatus.PASSED);
//        assertExecutedItem(tests.get(4), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(5), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(6), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(7), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(8), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(9), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(10), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(11), TestCaseStatus.FAILED);
//        assertExecutedItem(tests.get(12), TestCaseStatus.FAILED);
//    }
//
//    @Test
...
//    }
//
//    private static void assertExecutedItem(TestExecutionItem item, TestCaseStatus status)
//    {
//        assertItem(item, status, START.toString(), FINISH.toString());
//    }
//
//    private static void assertItem(TestExecutionItem item, TestCaseStatus status, String start, String finish)
//    {
